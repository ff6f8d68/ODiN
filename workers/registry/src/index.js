...
export default {
  async fetch(request, env) {
    ...
    // Handle API requests for registry.odin domain
    if (host === 'registry.odin' || host.includes('odin-registry.')) {
    ...
    // For non-API requests or when not accessing via registry.odin, serve assets
