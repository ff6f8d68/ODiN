const COLO_COORDS = {
  EWR: [40.69, -74.17], SJC: [37.36, -121.93], IAD: [38.95, -77.46],
  ORD: [41.98, -87.90], DFW: [32.90, -97.04], LAX: [33.94, -118.41],
  AMS: [52.31, 4.77], LHR: [51.47, -0.46], FRA: [50.04, 8.56],
  CDG: [49.01, 2.55], MAD: [40.47, -3.57], WAW: [52.17, 20.97],
  SIN: [1.36, 103.99], NRT: [35.76, 140.39], SYD: [-33.95, 151.18],
  GRU: [-23.43, -46.47], MIA: [25.79, -80.29], SEA: [47.45, -122.31],
  ATL: [33.64, -84.43], DEN: [39.86, -104.67], HKG: [22.31, 113.91],
};
...
export async function listDynamicPeers(kv) {
  if (!kv) return [];
...
export function pickNearestPeer(request, peers) {
  ...
  if (visitor.colo) {
    ...
    if (coloMatch) return { ...coloMatch, matchedBy: 'colo', peerCount: peers.length };
  }
